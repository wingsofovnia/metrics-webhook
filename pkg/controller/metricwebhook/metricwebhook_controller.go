...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileMetricWebhook{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MetricWebhook
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &metricsv1alpha1.MetricWebhook{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMetricWebhook) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &metricsv1alpha1.MetricWebhook{}
	...
	// Set MetricWebhook instance as the owner and controller
...
func newPodForCR(cr *metricsv1alpha1.MetricWebhook) *corev1.Pod {
